...
func main() {
	...
	go func() {
		if err := internal.Start("192.168.10.3:" + internalPort); err != nil && !errors.Is(err, http.ErrServerClosed) {
	...
	go func() {
		if err := e.Start("192.168.10.3:8010"); err != nil && !errors.Is(err, http.ErrServerClosed) {
